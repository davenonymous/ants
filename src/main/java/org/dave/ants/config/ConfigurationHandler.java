...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration() {
        ...
        ForagingGrounds.priceForWorkers = configuration.getFloat("Worker cost", ForagingGrounds.CONFIG_CATEGORY, 20.0f, 0.0f, Float.MAX_VALUE, "Price to hire another worker (in ants)");
        ...
        GeneralAntHillConfig.disabledHillProperties = configuration.getStringList("Properties to disable", GeneralAntHillConfig.CONFIG_CATEGORY, new String[] {}, "Risky to change! Must be specified by classname, e.g. org.dave.ants.api.properties.calculated.TotalQueens)");
