...
ResourceLoader loader = new ResourceLoader(new File(ConfigurationHandler.configDir, "types.d"), "assets/ants/config/types.d/");
...
public class ResourceLoader {
    ...
    public Map<String, InputStream> getResources() {
        ...
        if(DEVELOPMENT) {
            File assetPath = new File(Ants.class.getResource("/" + assetPathName).getFile());
            ...
            URL srcUrl = Ants.class.getResource("/" + assetPathName);
