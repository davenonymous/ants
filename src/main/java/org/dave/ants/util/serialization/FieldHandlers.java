    ...
    static {
        ...
        addNBTHandler(INBTSerializable.class, (key, tag) -> {
            ...
            try {
                ...
                obj.deserializeNBT(containerTag.getCompoundTag("chamberData"));
                return obj;
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            ...
            containerTag.setTag("chamberData", INBTSerializable.serializeNBT());
            tag.setTag(key, containerTag);
        });
        ...
        addNBTHandler(List.class, (key, tag) -> {
            ...
            try {
                ...
                for(NBTBase baseTag : containerTag.getTagList("values", Constants.NBT.TAG_COMPOUND)) {
                    NBTTagCompound entry = (NBTTagCompound)baseTag;
                    Object value = reader.read("chamberData", entry);
                    result.add(value);
                }
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            ...
            if(!list.isEmpty()) {
                ...
                for(Object e : list) {
                    ...
                    writer.write("chamberData", e, entryContainerTag);
